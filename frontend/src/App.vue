<template>
  <div id="app">
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-md-6 col-lg-4 rounded-md py-2 recipe-list-item " v-for="recipe in recipes" :key="recipe.name">
          <div class="recipe-list-item-inner w-100 h-100">
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="right-flex pl-1 text-right text-muted small">
                {{ recipe.totalTime }}
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    getStyleForRecipeTag: function(tag) {
      console.log(tag);
      let styles = [
        "background-color: #fde68a; color: #f59e0b; font-weight: bold;",
